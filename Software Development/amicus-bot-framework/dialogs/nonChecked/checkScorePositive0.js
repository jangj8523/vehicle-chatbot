...
class CheckScorePositive  extends ComponentDialog {
    ...
    constructor(dialogId) {
        ...
        this.addDialog(new WaterfallDialog(dialogId, [
            async function (step) {
                ...
                return await step.prompt('textPrompt', "Your team Bayern is up 4-0 and it’s the 82nd minute!");
            },
            async function (step) {
                // Save the room number and "sign off".

                await step.context.sendActivity(`It's great indeed.`);
...
module.exports.CheckScorePositive = CheckScorePositive;
