...
- Navigate to `amicus` folder
- Select `amicus.bot` file
...
msbot clone services --name "amicus" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
